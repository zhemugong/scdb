<template>
    ...
    <div>
        ...
        <el-card shadow="always">
            ...
            <el-row :gutter="10">
                <el-col :span="8">
                    <el-input v-model="queryInfo.condition" placeholder="请输入学生姓名进行查询" clearable @clear="selectSctByConditionAndPage">
    ...
    export default {
        ...
        methods:{
            ...
            selectSctByConditionAndPage(){
                this.common.getAllDataByConditionAndPage(this,this.apiUrl.selectSctByPageAndCondition);
            },
            selectAllSct(){
